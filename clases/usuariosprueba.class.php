...
class usuariosprueba extends ConexionCrud{
    ...
    public function obtenerUsuario($id){
        $query = "SELECT id_user,user_name,user_email,user_tel,user_state FROM " . $this->table . " WHERE id_user= '$id'";
        return parent::listar($query);
    }
    ...
    private function editarUsuario(){// modelo para editar los datos del usuario
        ...
        "',user_state='" .$this->user_state . "' WHERE id_user='" . $this->id_user . "'";
