...
class miperfil extends ConexionCrud{
        ...
        if(!isset($datos["token"])){
            ...
            if($arrayToken){
                if(!isset($datos['id_user'])){
                    ...
                    if(isset($datos["user_tel"])) { $this->user_tel = $datos['user_tel']; }
                    if(isset($datos["user_state"])) { $this->user_state = $datos['user_state']; }
                    if(isset($datos["id_workplace"])) { $this->id_workplace = $datos['id_workplace']; }
                    if(isset($datos["id_typejob"])) { $this->id_typejob = $datos['id_typejob']; }
                    if(isset($datos["id_title"])) { $this->id_title = $datos['id_title']; }
                    if(isset($datos["firstname"])) { $this->firstname = $datos['firstname']; }
                    if(isset($datos["middlename"])) { $this->middlename = $datos['middlename']; }
                    if(isset($datos["lastname"])) { $this->lastname = $datos['lastname']; }
                    if(isset($datos["facebook"])) { $this->facebook = $datos['facebook']; }
                    if(isset($datos["addres1"])) { $this->addres1 = $datos['addres1']; }
                    if(isset($datos["addres2"])) { $this->addres2 = $datos['addres2']; }
                    if(isset($datos["codezip"])) { $this->codezip = $datos['codezip']; }
    ...
    private function editarUsuario(){// modelo para editar los datos del usuario
        ...
        "',tab2.id_workplace='" .$this->id_workplace .
        "',tab2.id_typejob='" .$this->id_typejob .
        "',tab2.id_title='" .$this->id_title .
        "',tab2.firstname='" .$this->firstname . 
        "',tab2.middlename='" .$this->middlename .
        "',tab2.lastname='" .$this->lastname .
        "',tab2.facebook='" .$this->facebook .
        "',tab2.addres1='" .$this->addres1 .
        "',tab2.addres2='" .$this->addres2 .
        "',tab2.codezip='" .$this->codezip .
